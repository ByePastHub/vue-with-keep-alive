import{c as s}from"./app.4a40ba51.js";import{_ as n}from"./plugin-vue_export-helper.21dcd24c.js";const a={},e=s(`<h1 id="destroy" tabindex="-1"><a class="header-anchor" href="#destroy" aria-hidden="true">#</a> Destroy</h1><p>If you need to destroy the cached page components, you can use destroy to destroy</p><ul><li>The destroy property and method parameters are Route.name <code>String | Array</code>, the only special value: <code>ALL</code> destroy all</li><li>Provide the <code>$keepRouter</code> global object in the Vue instance</li></ul><h3 id="destroy-inside-vue-instance" tabindex="-1"><a class="header-anchor" href="#destroy-inside-vue-instance" aria-hidden="true">#</a> Destroy inside Vue instance</h3><div class="language-vue ext-vue line-numbers-mode"><pre class="shiki" style="background-color:#1E1E1E;"><code><span class="line"><span style="color:#D4D4D4;">&lt;router-link :to=&quot;{name: &#39;Home&#39;, destroy: &#39;About&#39;}&quot;&gt;</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div>`,7);function l(p,t){return e}var c=n(a,[["render",l]]);export{c as default};
