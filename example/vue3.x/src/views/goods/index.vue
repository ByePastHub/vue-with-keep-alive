<template>
  <div class="goods">
    ...
    <van-cell-group class="goods-cell-group">
      <van-cell value="进入购物车" icon="cart" is-link @click="$router.push({name: 'cart'})">
        <template #title>
          <span class="van-cell-text">不销毁本页面，跳转回购物车</span>
          <van-tag class="goods-tag" type="danger">点击</van-tag>
        </template>
      </van-cell>
      <van-cell title="线下门店" icon="cart" is-link @click="$router.push({name: 'cart', destroy: 'goods'})">
        <template #title>
          <span class="van-cell-text">销毁本页面，跳转回购物车</span>
          <van-tag class="goods-tag" type="danger">点击</van-tag>
        </template>
      </van-cell>
    </van-cell-group>
    ...
    <van-cell-group class="goods-cell-group">
      <van-cell title="回到购物车，销毁全部页面" is-link @click="$router.push({name: 'cart', destroy: 'ALL'})">
        <van-tag class="goods-tag" type="danger">点击</van-tag>
      </van-cell>
    </van-cell-group>
